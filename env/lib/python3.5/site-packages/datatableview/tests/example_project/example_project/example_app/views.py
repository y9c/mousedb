...
class DemoMixin(object):
    ...
    def get_template_names(self):
        ...
        name = self.__class__.__name__.replace("datatable_view", "")
...
class ZeroConfigurationDatatableView(DemoMixin, DatatableView):
    """
    If no columns are specified in the view's ``datatable_options`` attribute, ``datatable_view``
    ...
    implementation = u"""
    class ZeroConfigurationDatatableView(datatable_view):
        model = Entry
    """
...
class SpecificColumnsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class SpecificColumnsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class PrettyNamesDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class PrettyNamesDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'blog',
...
class PresentationalChangesDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    from django.template.defaultfilters import timesince
    class PresentationalChangesDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'blog',
...
class VirtualColumnDefinitionsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    from django.template.defaultfilters import timesince
    class VirtualColumnDefinitionsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'blog',
...
class ColumnBackedByMethodDatatableView(DemoMixin, DatatableView):
    ...
    implementation = """
    class ColumnBackedByMethodDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'blog',
...
class CompoundColumnsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
        class CompoundColumnDatatableView(datatable_view):
            model = Entry
            datatable_options = {
                'columns': [
                    'id',
...
class RelatedFieldsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class RelatedFieldsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class ManyToManyFieldsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class ManyToManyFields(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class DefaultCallbackNamesDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class DefaultCallbackNamesDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class XEditableColumnsDatatableView(DemoMixin, XEditableDatatableView):
    ...
    plain ``datatable_view``.  The x-editable variant has ajax responders built into it so that the
...
class PerRequestOptionsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class PerRequestOptionsDatatableView(DemoMixin, datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class OrderingDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class OrderingDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class UnsortableColumnsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class UnsortableColumnsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class HiddenColumnsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class HiddenColumnsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class SearchFieldsDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class SearchFieldsDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class CustomizedTemplateDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class CustomizedTemplateDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'structure_template': "custom_table_template.html",
            'columns': [
...
class BootstrapTemplateDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class BootstrapTemplateOfficialDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'structure_template': "datatableview/bootstrap_structure.html",
            'columns': [
...
class CSSStylingDatatableView(DemoMixin, DatatableView):
    ...
    implementation = u"""
    class CSSStylingDatatableView(datatable_view):
        model = Entry
        datatable_options = {
            'columns': [
                'id',
...
class MultipleTablesDatatableView(DemoMixin, DatatableView):
    """
    ``datatable_view`` makes the initial assumption that it will power just one queryset.  You can
    ...
    ``model``.  Instead, you can let the standard ``ListView`` mechanics that ``datatable_view`` uses
    ...
    implementation = u'''
    from .models import Entry, Blog
    class MultipleTablesDatatableView(datatable_view):
        # Demo #1 and Demo # 2 will use variations of the same options
        model = Entry
        datatable_options = {
            'columns': [
...
class EmbeddedTableDatatableView(DemoMixin, TemplateView):
    ...
    call to a ``datatable_view.get_datatable()`` uses to get the context variable: the ``ajax_url``
    ...
    class SatelliteDatatableView(datatable_view):
        """
